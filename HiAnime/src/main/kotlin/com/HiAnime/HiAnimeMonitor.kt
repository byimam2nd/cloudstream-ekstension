...
/**
 * HiAnime-specific cache monitor
 */
class HiAnimeMonitor : SmartCacheMonitor() {
    ...
    /**
     * Fetch titles dari HiAnime homepage
     * Selector: "div.flw-item h3.film-name"
     */
    override suspend fun fetchTitles(url: String): List<String> {
        return try {
            ...
            // Selector untuk film name
            document.select("div.flw-item h3.film-name")
