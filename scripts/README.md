...
**Fungsi:** Sync `master/MasterExtractors.kt` ke semua active modules.
...
**Trigger:**
- Push ke `master` dengan perubahan `master/MasterExtractors.kt`
- Pull request dengan perubahan `master/MasterExtractors.kt`
...
1. Edit `master/MasterExtractors.kt`:
...
grep -c "^class \|^open class " master/MasterExtractors.kt

# Cek AllExtractors.list
grep -A 100 "object AllExtractors" master/MasterExtractors.kt | grep -c "()"
...
- [MasterExtractors.kt](../master/MasterExtractors.kt) - Source code
