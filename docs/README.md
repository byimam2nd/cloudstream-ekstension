...
Old research and planning documents are stored in [`archive-old/2026-03-research/`](archive-old/2026-03-research/):

- `EXTRACTOR_PLANNING.md` - Initial extractor planning (superseded)
- `DEEP_RESEARCH_EXTRACTORS.md` - Research phase documentation (superseded)
- `MASTER_EXTRACTOR_COLLECTION.md` - Old extractor collection (superseded)
- `PARALLEL_LINK_EXTRACTION_TEMPLATE.md` - Old template (obsolete)
- `CACHING_TEMPLATE.md` - Old caching guide (obsolete)
...
**For Users:**
1. Start with [README-StremioAddon.md](README-StremioAddon.md) or [README-StremioX.md](README-StremioX.md)
