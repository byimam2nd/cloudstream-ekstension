...
class Dramabox : MainAPI() {
    ...
    private fun buildMainUrl(): String {
        val codes = intArrayOf(104, 116, 116, 112, 115, 58, 47, 47, 119, 119, 119, 46, 100, 114, 97, 109, 97, 98, 111, 120, 46, 99, 111, 109, 47, 105, 110)
        return codes.joinToString("") { it.toChar().toString() }
    }

    private fun buildApiUrl(): String {
        val codes = intArrayOf(104, 116, 116, 112, 115, 58, 47, 47, 100, 98, 46, 104, 97, 102, 105, 122, 104, 105, 98, 110, 117, 115, 121, 97, 109, 46, 109, 121, 46, 105, 100)
        return codes.joinToString("") { it.toChar().toString() }
    }
